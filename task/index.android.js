    ...
    return (
      ...
      <Container>
          ...
          <Header style={{backgroundColor:'#01cca1'}}>
                    ...
                    <Text style={{alignItems:'center',justifyContent:'center',marginLeft:100,textAlign:'center',alignSelf:'center',color:'white',fontWeight:'bold',fontSize:34}}> F
                    </Text></Title>
          ...
          <View style={{flex:1,borderLeftWidth:2 ,borderColor:'grey',marginLeft:5 ,marginTop:3 ,padding:12}}>
          </View>
          ...
          <View style={{flex:1,borderLeftWidth:2 ,borderColor:'grey',marginLeft:5 ,marginTop:3 ,padding:20}}>
